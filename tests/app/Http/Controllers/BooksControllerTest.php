...
class BooksControllerTest extends TestCase
{
    ...
    {
      $this->get('/books/99999', ['Accept' => 'application/json'])->seeStatusCode(404)
      ->seeJson([
            'message' => 'Not Found',
            'status' => 404
      ]);
    ...
    public function store_should_save_new_book_in_the_database()
    {
      ...
      $this->assertEquals(
          'An invisible man is trapped in the terror of his own creation',$data['description']
      );
    ...
    {
      $this->put('/books/99999999999999999999')
      ->seeStatusCode(404)
      ->seeJsonEquals([
        'error' => [
    ...
    /** @test **/
    public function destory_should_not_match_an_invalid_route()
    {
